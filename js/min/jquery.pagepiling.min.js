...
!(function (e, n, t, o) {
    ...
    e.fn.pagepiling = function (i) {
            ...
            if (!o.activeSection.is(n)) {
                "undefined" == typeof o.animated && (o.animated = !0),
                    ...
                    "down" === o.yMovement
                        ...
                        : ((o.translate3d = "translate3d(0px, 0px, 0px)"), (o.scrolling = "0"), (o.animateSection = n)),
                    e.isFunction(Z.onLeave) && Z.onLeave.call(this, o.leavingSection, o.sectionIndex + 1, o.yMovement),
                    r(o),
                    A(o.anchorLink),
        ...
        function r(n) {
            Z.css3
                ...
                : ((n.scrollOptions = u(n.scrolling)),
                  n.animated
                      ? n.animateSection.animate(n.scrollOptions, Z.scrollingSpeed, Z.easing, function () {
                            d(n), l(n);
                        })
        ...
        function D() {
            var e;
            return (e = t.PointerEvent ? { down: "pointerdown", move: "pointermove", up: "pointerup" } : { down: "MSPointerDown", move: "MSPointerMove", up: "MSPointerUp" });
        }
        function I(e) {
            var n = new Array();
                ...
                if ((i.length || n.preventDefault(), !m())) {
                    ...
                    (K = a.y),
                        ...
                        "horizontal" === Z.direction && Math.abs(H - V) > Math.abs(j - K)
                            ? Math.abs(H - V) > (F.width() / 100) * Z.touchSensitivity && (H > V ? x("down", i) : V > H && x("up", i))
                            : Math.abs(j - K) > (F.height() / 100) * Z.touchSensitivity && (j > K ? x("down", i) : K > j && x("up", i));
                }
            }
        }
        function N(n, t) {
        ...
        e.extend(e.easing, {
            ...
            Z.css3 && (Z.css3 = O()),
            e(F).css({ overflow: "hidden", "-ms-touch-action": "none", "touch-action": "none" }),
        ...
        e(".pp-section")
            .each(function (n) {
                e(this).data("data-index", n),
                    ...
                    "undefined" != typeof Z.anchors[n] && e(this).attr("data-anchor", Z.anchors[n]),
                    "undefined" != typeof Z.sectionsColor[n] && e(this).css("background-color", Z.sectionsColor[n]),
                    Z.verticalCentered && !e(this).hasClass("pp-scrollable") && a(e(this)),
                    ($ -= 1);
            })
            .promise()
            .done(function () {
                Z.navigation && (e("#pp-nav").css("margin-top", "-" + e("#pp-nav").height() / 2 + "px"), e("#pp-nav").find("li").eq(e(".pp-section.active").index(".pp-section")).find("a").addClass("active")),
            ...
            e(n).on(
                {
                    mouseenter: function () {
                        ...
                        e('<div class="pp-tooltip ' + Z.navigation.position + '">' + n + "</div>")
                            .hide()
                            .appendTo(e(this))
                            .fadeIn(200);
                    },
